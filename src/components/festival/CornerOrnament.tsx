...
const CornerOrnament = forwardRef<HTMLDivElement, CornerOrnamentProps>(
  ({ position, variant = "floral", className = "" }, _ref) => {
    const internalRef = useRef(null);
    const isInView = useInView(internalRef, { once: true, margin: "-20px" });
